...
<b>NOTE:</b>
1. Rock should have admin privillage.
...
- Rock Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. Rock supports buttons with any telegram media type.
...
<b>NOTE:</b>
these are the extra features of Rock 
